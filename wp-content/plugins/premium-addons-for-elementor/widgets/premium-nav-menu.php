...
class Premium_Nav_Menu extends Widget_Base {
	...
	private function get_menu_settings_controls() {
		...
		$repeater->add_responsive_control(
			...
			array(
				...
				'description' => __( 'This option centers the mega content to the center of the widget container.', 'premium-addons-for-elementor' ),
				'condition'   => array(
					'item_type'         => 'submenu',
					'menu_content_type' => 'custom_content',
				),
	...
	private function get_menu_content_controls() {
		...
		$this->add_control(
			'menu_heading',
			array(
				'label' => esc_html__( 'Menu Settings', 'premium-addons-for-elementor' ),
		...
		$this->add_control(
			'pointer',
			array(
				'label'          => esc_html__( 'Item Hover Effect', 'premium-addons-for-elementor' ),
				'type'           => Controls_Manager::SELECT,
				'default'        => 'none',
				'options'        => array(
		...
		$this->add_control(
			'submenu_heading',
			array(
				'label'     => esc_html__( 'Submenu Settings', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	private function get_sticky_option_settings() {
		...
		$this->add_control(
			'pa_sticky_target',
			array(
				'label'              => esc_html__( 'Sticky Target ID', 'premium-addons-for-elementor' ),
				'type'               => Controls_Manager::TEXT,
				'frontend_available' => true,
				'render_type'        => 'template',
	...
	private function get_vertical_toggle_settings() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::TEXT,
				'default'   => esc_html__( 'Premium Menu', 'premium-addons-for-elementor' ),
				'condition' => array(
					'pa_nav_menu_layout'     => 'ver',
		...
		$this->add_control(
			...
			array(
				'label'       => esc_html__( 'Title Icon', 'premium-addons-for-elementor' ),
				'type'        => Controls_Manager::ICONS,
				'label_block' => false,
				'skin'        => 'inline',
				'default'     => array(
	...
	private function get_dropdown_content_settings( $align_left, $align_right ) {
		...
		$this->add_control(
			'btn_toggle_heading',
			array(
				'label' => esc_html__( 'Toggle Button', 'premium-addons-for-elementor' ),
				'type'  => Controls_Manager::HEADING,
			)
		);
	...
	private function get_toggle_menu_sytle() {
		...
		$this->add_control(
			'pa_ham_menu_style',
			array(
				'label'     => esc_html__( 'Toggle Menu', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
	...
	private function get_menu_item_style() {
		...
		$this->add_control(
			...
			array(
				'label'     => esc_html__( 'Item Hover Effect Color', 'premium-addons-for-elementor' ),
				'type'      => Controls_Manager::COLOR,
				'global'    => array(
					'default' => Global_Colors::COLOR_SECONDARY,
				),
